    ...
    <Card style={{ height: "73vh" }}>
      ...
      <Card.Body style={{ overflowY: "auto" }}>
        ...
        <Form.Group controlId="formBanner7" className="mb-3">
          <Form.Label>
            8. Has he or she gone to see the authorities? What happened? Remember
            the US Government gives asylum to those who were persecuted by the
            government or by forces where the government was unable or unwilling
            to protect them. Therefore, we must question them about the effort
            that they made in seeking governmental protection, and we must
            clearly show that in those stories. If the client was in a foreign
            country, where he or she was persecuted because of her race or
            nationality, we must show the disregard of the government or the
